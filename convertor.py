...
def convertor():
    ...
    result = conv.funConvetor(src_currency,amount,dest_currency,ference_date)
...
class convertor:
	...
	# function CONVERTOR    
    def funConvetor(self,var_src_currency,var_montant,var_dest_currency,var_ference_date):
        rest = {}
